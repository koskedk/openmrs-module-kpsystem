...
<div class="ke-panel-content">
	...
	<div style="width:auto; margin:0 auto; text-align: center; background-color: #803625; padding: 10px; border-radius: 4px">
		...
		<a href="../help/releases/index.html") }" style="color: white;" target="_blank"> <img src="${ ui.resourceLink("kpsystem", "images/help/releases.png") }" /></a>
	</div>
	<br />
	<div style="width: auto; margin:0 auto; text-align: left; background-color: #803625; padding: 10px; border-radius: 4px; valign: top">
	    ...
	    <div>
	        <a href="../help/eSessions/index.html"><img src="${ ui.resourceLink("kpsystem", "images/help/esessions_icon.png") }" /></a>
	        <a href="../help/index.html"><img src="${ ui.resourceLink("kpsystem", "images/help/job_aids_icon.png") }" /></a>
	        <a href="../help/guidelines/index.html"><img src="${ ui.resourceLink("kpsystem", "images/help/guidelines_icon.png") }" /></a>
	        <a href="../help/analysis-tools/index.html"><img src="${ ui.resourceLink("kpsystem", "images/help/analysis_tools_icon.png") }" /></a>
	    </div>
	</div>
	<br />
	<div style="width:auto; margin:0 auto; text-align: left; background-color: #803625; padding: 10px; border-radius: 4px" valign: top>
	    <h4 style="color: white; valign: top">Contact Information</h4>
	     <div>
            <img src="${ ui.resourceLink("kpsystem", "images/help/champion_icon.png") }"  target="_blank" />
            <img src="${ ui.resourceLink("kpsystem", "images/help/email_icon.png") }"  target="_blank" />
            <img src="${ ui.resourceLink("kpsystem", "images/help/phone_icon.png") }"  target="_blank" />
           </div>
    </div>
