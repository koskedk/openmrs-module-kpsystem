<%
	...
	def onReportClick = { report ->
		...
		"""ui.navigate('${ ui.pageLink('kpsystem', 'report', opts) }');"""
	}
				...
				<tr>
					<td style="width: 50%; vertical-align: top">
						<div class="ke-panel-frame">
							...
							<div class="ke-panel-content">
								${ ui.includeFragment("kpsystem", "widget/reportStack", [ reports: indicatorReports(reports), onReportClick: onReportClick ]) }
							</div>
						</div>
					</td>
					<td style="width: 50%; vertical-align: top; padding-left: 5px">
						<div class="ke-panel-frame">
							...
							<div class="ke-panel-content">
								${ ui.includeFragment("kpsystem", "widget/reportStack", [ reports: cohortReports(reports), onReportClick: onReportClick ]) }
							</div>
						</div>
					</td>
				</tr>
