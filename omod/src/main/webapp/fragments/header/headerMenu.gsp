<%
	...
	if (context.authenticatedUser) {
		...
		appMenuItems << """<a href="/${ contextPath }/kpsystem/userHome.page?${ config.context ? config.context : "" }"><img src="${ ui.resourceLink("kpui", "images/toolbar/home.png") }" width="12" height="12" />&nbsp;&nbsp;Home</a>"""
