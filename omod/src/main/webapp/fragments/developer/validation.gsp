<%
	ui.decorateWith("kpui", "panel", [ heading: "Patient Validation", frameOnly: true ])
		...
		<table class="ke-table-vertical">
			...
			<tbody>
				<tr ng-repeat="result in results">
					<td>
						<img ng-src="${ ui.resourceLink("kpui", "images/glyphs/patient_") }{{ result.patient.gender }}.png" class="ke-glyph" />
						<a ng-href="${ ui.pageLink("kpsystem", "chart/chartViewPatient") }?patientId={{ result.patient.id }}">{{ result.patient.name }}</a>
					</td>
					<td>
