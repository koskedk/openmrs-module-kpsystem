<div class="ke-panel-frame">
	...
	<div class="ke-panel-content">
		${ ui.includeFragment("kpui", "widget/dataPoint", [ label: "Real name", value: kenyaui.formatPersonName(person) ]) }
		${ ui.includeFragment("kpui", "widget/dataPoint", [ label: "Gender", value: kenyaui.formatPersonGender(person) ]) }
		${ ui.includeFragment("kpui", "widget/dataPoint", [ label: "Telephone", value: ui.format(form.telephoneContact) ]) }
		${ ui.includeFragment("kpui", "widget/dataPoint", [ label: "Email", value: ui.format(form.emailAddress) ]) }
	</div>
