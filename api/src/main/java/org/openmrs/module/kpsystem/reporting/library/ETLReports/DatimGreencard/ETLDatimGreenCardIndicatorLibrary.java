 ...
 */
package org.openmrs.module.kpsystem.reporting.library.ETLReports.DatimGreencard;
 ...
 */
@Component
public class ETLDatimGreenCardIndicatorLibrary {
    @Autowired
    private ETLDatimGreenCardCohortLibrary datimCohorts;
