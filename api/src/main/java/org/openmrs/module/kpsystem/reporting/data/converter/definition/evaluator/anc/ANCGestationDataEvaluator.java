...
import org.openmrs.module.kpsystem.reporting.data.converter.definition.anc.ANCGestationDataDefinition;
...
public class ANCGestationDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select\n" +
                "  v.encounter_id,\n" +
                "  round(DATEDIFF(v.visit_date,e.lmp)/7) as gestation_in_weeks\n" +
