...
import org.openmrs.module.kpsystem.reporting.data.converter.definition.hei.HEIGivenNVP6_8WeeksDataDefinition;
...
public class HEIGivenNVP6_8WeeksDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select\n" +
                "  f.patient_id,\n" +
                "  (case f.nvp_given when 80586 then \"Yes\" else \"No\" end) as nvp_given_six_weeks\n" +
